...
-   ### Motif and Pattern Search in Sequences  序列模体和样式搜索
    ...
    -   [Gibbs Motif Sampler](http://ccmbweb.ccv.brown.edu/gibbs/gibbs.html)  
        - identification of conserved motifs in DNA or protein sequences
    -   [AlignACE Homepage](http://arep.med.harvard.edu/mrnadata/mrnasoft.html)  
        - gene regulatory motif finding
    -   [MEME](http://meme.nbcr.net/meme/intro.html)   
        - motif discovery and search in protein and DNA sequences
    ...
    -   [Motivated Proteins](http://motif.gla.ac.uk/motif/index.html)  
        - a web facility for exploring small hydrogen-bonded motifs
...
-   ### Protein 3D Structure  蛋白质三维结构
    ...
    -   [RasMol / Protein Explorer](http://www.umass.edu/microbio/rasmol/)  
        - molecule 3D structure viewers
    -   [UCL BSM CATH classification](http://scop.mrc-lmb.cam.ac.uk/scop/)
    ...
    -   [Structure Prediction Meta-server](https://www.genesilico.pl/meta2/)
    -   [K2](http://zlab.bu.edu/k2)  
        - protein structure alignment
    -   [DALI](http://ekhidna.biocenter.helsinki.fi/dali_server/)  
        - 3D structure alignment server
    -   [DSSP](http://swift.cmbi.ru.nl/gv/dssp/)  
        - defines secondary structure and solvent exposure from 3D coordinates
    -   [HSSP Database](http://swift.cmbi.ru.nl/gv/hssp/)  
        - Homology-derived Secondary Structure of Proteins
    -   [PredictProtein & PHD](https://www.predictprotein.org/)  
    ...
    -   [PSIpred (& MEMSAT & GenTHREADER)](http://bioinf.cs.ucl.ac.uk/psipred/)  
        - protein secondary structure prediction (& transmembrane helix prediction & tertiary structure prediction by threading)
...
-   ### Synthetic Biology  合成生物学
    ...
    [File format converter](http://synbio.mit.edu/tools/converter.cgi "http://synbio.mit.edu/tools/converter.cgi")  
    ...
    [TinkerCell](http://www.tinkercell.com/ "http://www.tinkercell.com")  
...
-   ### Medical Image Repositorie  医学影像库
    ...
    -   [**MIDAS**](http://www.insight-journal.org/midas/)
...
-   ### Bioinformatics on-line course materials and tutorials  生物信息学在线课程教材
    ...
    [Microarray Data Analysis](http://www.statsci.org/micrarra/)  
...
-   ### Bioinformatics Journals  相关期刊
    ...
    -   [IEEE/ACM Transactions on Computational Biology and Bioinformatics](http://www.computer.org/portal/web/tcbb/home)
